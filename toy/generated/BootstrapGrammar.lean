...
def patternPiece : Piece := {
  ...
  grammar := [
    ...
    ("Pattern.patternArg", ((node "binder" ((((lit "$").seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Pattern.pattern"))).alt ((node "labeledArg" (((ref "Atom.ident").seq (lit ":")).seq (ref "Pattern.pattern"))).alt (ref "Pattern.pattern")))),
...
def templatePiece : Piece := {
  ...
  grammar := [
    ...
    ("Template.templateArg", ((node "binder" ((((lit "$").seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Template.template"))).alt ((node "labeledArg" (((ref "Atom.ident").seq (lit ":")).seq (ref "Template.template"))).alt (ref "Template.template")))),
