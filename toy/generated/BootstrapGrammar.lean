...
def patternPiece : Piece := {
  name := "Pattern"
  grammar := [
    ("Pattern.pattern", ((node "binder" ((((lit "$").seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Pattern.pattern"))).alt ((node "var" ((lit "$").seq (ref "Atom.ident"))).alt ((node "subst" ((((((lit "[").seq (ref "Pattern.pattern")).seq (lit ":=")).seq (ref "Pattern.pattern")).seq (lit "]")).seq (ref "Pattern.pattern"))).alt ((node "bracket" (((lit "[").seq ((ref "Pattern.patternArg").star)).seq (lit "]"))).alt ((node "tuple" (((((lit "(").seq (ref "Pattern.pattern")).seq (lit ",")).seq (ref "Pattern.pattern")).seq (lit ")"))).alt ((node "unit" ((lit "(").seq (lit ")"))).alt ((node "binderParen" ((((((lit "(").seq (lit "$")).seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Pattern.pattern")).seq (lit ")"))).alt ((node "objBinderParen" (((((lit "(").seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Pattern.pattern")).seq (lit ")"))).alt ((node "ann" (((((lit "(").seq (ref "Pattern.pattern")).seq (lit ":")).seq (ref "Pattern.pattern")).seq (lit ")"))).alt ((node "con" ((((lit "(").seq (ref "Pattern.patternHead")).seq ((ref "Pattern.patternArg").star)).seq (lit ")"))).alt ((node "lit" (ref "Atom.string")).alt ((node "num" (ref "Atom.number")).alt (node "con" (ref "Atom.ident"))))))))))))))),
    ("Pattern.patternArg", ((node "binder" ((((lit "$").seq (ref "Atom.ident")).seq (lit ".")).seq (ref "Pattern.pattern"))).alt ((node "typedVar" ((((lit "$").seq (ref "Atom.ident")).seq (lit ":")).seq (ref "Pattern.pattern"))).alt ((node "labeledArg" (((ref "Atom.ident").seq (lit ":")).seq (ref "Pattern.pattern"))).alt ((node "objBinder" (((ref "Atom.ident").seq (lit ".")).seq (ref "Pattern.pattern"))).alt ((node "con" (lit "~>")).alt ((node "con" (lit "→")).alt ((node "con" (lit "×")).alt ((node "con" (lit "↦")).alt ((node "con" (lit "=I=")).alt ((node "con" (lit "@@")).alt ((node "con" (lit "-")).alt (ref "Pattern.pattern"))))))))))))),
