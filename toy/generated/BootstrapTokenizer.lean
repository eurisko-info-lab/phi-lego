...
def tokenPiece : Piece := {
  ...
  level := .token
  grammar := [
    ("Token.digit", ((lit "0").alt ((lit "1").alt ((lit "2").alt ((lit "3").alt ((lit "4").alt ((lit "5").alt ((lit "6").alt ((lit "7").alt ((lit "8").alt ((lit "9").alt ((lit "²").alt (lit "³"))))))))))))),
    ...
    ("Token.mathsym", ((lit "≈").alt ((lit "≅").alt ((lit "≤").alt ((lit "≥").alt ((lit "∘").alt ((lit "⊗").alt ((lit "⊙").alt ((lit "∧").alt ((lit "∨").alt ((lit "∷").alt ((lit "≡").alt ((lit "⋆").alt ((lit "¯").alt ((lit "⊤").alt ((lit "⊥").alt ((lit "¹").alt ((lit "₀").alt ((lit "₁").alt ((lit "₂").alt ((lit "₃").alt ((lit "₄").alt ((lit "₅").alt ((lit "₆").alt ((lit "₇").alt ((lit "₈").alt (lit "₉"))))))))))))))))))))))))))),
    ("Token.alpha", ((ref "Token.lower").alt ((ref "Token.upper").alt ((ref "Token.greek").alt ((ref "Token.mathbb").alt ((ref "Token.mathsym").alt (lit "_"))))))),
    ("Token.symch", ((lit "(").alt ((lit ")").alt ((lit "[").alt ((lit "]").alt ((lit "{").alt ((lit "}").alt ((lit "<").alt ((lit ">").alt ((lit ":").alt ((lit ";").alt ((lit ",").alt ((lit ".").alt ((lit "|").alt ((lit "!").alt ((lit "?").alt ((lit "@").alt ((lit "#").alt ((lit "$").alt ((lit "%").alt ((lit "^").alt ((lit "&").alt ((lit "*").alt ((lit "+").alt ((lit "-").alt ((lit "=").alt ((lit "~").alt ((lit "/").alt ((lit "\\").alt ((lit "→").alt ((lit "←").alt ((lit "↔").alt ((lit "⊕").alt ((lit "⊢").alt ((lit "×").alt ((lit "λ").alt ((lit "∂").alt ((lit "∀").alt ((lit "∃").alt ((lit "⦉").alt ((lit "⦊").alt ((lit "«").alt ((lit "»").alt ((lit "★").alt ((lit "☆").alt (lit "`")))))))))))))))))))))))))))))))))))))))))))))),
